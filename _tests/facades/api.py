...
class ApiFacade:
	...
	def get_from_runs_by_user_spot_date(self):
		r = requests.get('http://' + self.api_server_host + ':' + self.api_server_port + '/User/Friends', 
			headers={'Authorization': 'JWT ' + bt_token})
		print 'Received /User/Friends response: ' + r.text
		return json.loads(r.text)
	...
	def get_from_runs_by_user_date(self, user_id, time_start_min, time_start_max):
	...
	def get_from_runs_by_user_segment_date(self):
		pass

	def get_from_runs_by_spot_user_date(self):
		pass

	def get_from_runs_by_segment_date_time(self):
		pass

	def get_from_runs_by_segment_user_date(self):
		pass

	def get_from_runs_by_segment_time(self):
		pass
